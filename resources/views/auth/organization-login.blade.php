...
<head>
    ...
    <title>PPT | Organization Log in</title>
...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('organization.login.submit') }}">
                {{ csrf_field() }}
            ...
            <div class="social-auth-links text-center mb-3">
                ...
                <a href="#" class="btn btn-block btn-primary">
                    <i class="fab fa-facebook mr-2"></i> Talk Admin
                </a>
