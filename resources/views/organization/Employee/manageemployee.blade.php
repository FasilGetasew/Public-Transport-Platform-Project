    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Selam Bus</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('organization.manageemployee')}}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Manage Employee</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('organization.bookedtickets')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Booked Tickets</p>
                                </a>
                            </li>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Fasil Getasew</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> Public transport driver </p>
                                            <ul class="ml-4 mb-0 fa-ul text-muted">
                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Gondar Street autoparko, Bahirda City 04312, Kebele 02</li>
                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: + 251 - 97 22 59 449</li>
                                            </ul>
                                        </div>
                                        <div class="col-5 text-center">
                                            <img src="{{asset('fasil.jpg')}}" alt="" class="img-circle img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="text-right">
                                        ...
                                        <a href="#" class="btn btn-sm btn-warning">
                                            <i class="fas fa-comments"> Update</i>
                                        </a>
